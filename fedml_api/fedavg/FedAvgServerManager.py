...
from fedml_api.fedavg import utils
from fedml_api.fedavg.GeneticClientSelector import FedAvgClientSelector
from fedml_api.fedavg.message_define import MyMessage
...
class FedAVGServerManager(ServerManager):
    def __init__(self, args, aggregator, comm=None, rank=0, size=0, backend="MPI"):
        ...
        self.client_selector = FedAvgClientSelector(args, [])
        self.args = args
    ...
    def handle_message_receive_model_from_client(self, msg_params):
        ...
        if b_all_received:
            ...
            self.aggregator.test_on_all_sub_models(self.round_idx)
            utils.json_save(self.aggregator.model_influence)
